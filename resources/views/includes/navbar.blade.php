            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
                        <label class="badge badge-light-primary">11</label><a class="sidebar-link sidebar-title"
                            href="seller-list.html#">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"> </i><a class="sidebar-link sidebar-title"
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <label class="badge badge-light-success">New</label><a
                                    href="scope-project.html">Project Details</a>
                            </li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title" href="seller-list.html#">
                            <svg class="stroke-icon">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a class="submenu-title" href="seller-list.html#">Products<span class="sub-arrow"><i
                            ...
                            <li>
                                <label class="badge badge-light-success">New</label><a class="submenu-title"
                                    href="seller-list.html#">Seller<span class="sub-arrow"><i
                                            class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li><a class="submenu-title" href="seller-list.html#">Orders<span class="sub-arrow"><i
                                            class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li><a class="submenu-title" href="seller-list.html#">Invoices<span class="sub-arrow"><i
                                            class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="mail-box.html">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            <li><a class="submenu-title" href="seller-list.html#">Form Controls<span
                            ...
                            <li><a class="submenu-title" href="seller-list.html#">Form Widgets<span
                                        class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li><a class="submenu-title" href="seller-list.html#">Form layout<span
                                        class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            <li><a class="submenu-title" href="seller-list.html#">Bootstrap Tables<span
                                        class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                            ...
                            <li><a class="submenu-title" href="seller-list.html#">Data Tables<span
                                        class="sub-arrow"><i class="fa-solid fa-angle-right"></i></span></a>
                                <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="pricing.html">
                            <svg class="stroke-icon">
