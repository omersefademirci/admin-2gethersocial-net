...
@section('pages-styles')
    <style>
        ...
        .admodel-colorbox.cpc {
            background-color: #A2A7FE;
            color: #ffffff;
        }

        .admodel-colorbox.cps {
            background-color: #76E7CA;
            color: #ffffff;
        }

        .admodel-colorbox.cpm {
            background-color: #FFC629;
            color: #ffffff;
        }

        .admodel-colorbox.cpi {
            background-color: #FF7D97;
            color: #ffffff;
        }

        .admodel-colorbox.cpv {
        ...
        body.dark-only table.dataTable tbody tr:hover {
                ...
                <div class="container-fluid dashboard-5">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                @foreach ($platformMetrics as $metric)
                                    <div class="col s-xxl-3 box-col-4">
                                        <div
                                            class="card social-widget widget-hover card-status-{{ strtolower($metric['status']) }}">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <span class="font-success f-12 d-xxl-block">
                                                        @php
                                                            $metricKey = strtolower($metric['status']);
                                                            $localizedMetric = __('custom.status.' . $metricKey);
                                                        @endphp
                                                        {{ $localizedMetric }}
                                                    </span>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex media-wrapper justify-content-between">
                                        ...
                                        <div class="greeting-user">
                                            <h2 class="f-w-600 pb-3">{{ __('custom.brands_title') }} <br>{{ $brand->name }}
                                            </h2>
                                            @if ($highestConversionCampaign['campaign'])
                                                <div style="max-width:70%;">
                                                    {{ $highestConversionCampaign['campaign']->campaign_name }}
                                                    {{ __('custom.highest_conversion_campaign') }}
                                                    {{ Number::format($highestConversionCampaign['highest_value'], locale: 'tr') }}
                                                    @php
                                                        switch ($highestConversionCampaign['highest_metric_name']) {
                                                            case 'Tıklamalar':
                                                                echo __('custom.clicks');
                                                                break;
                                                            case 'Satışlar':
                                                                echo __('custom.sales');
                                                            case 'İzlenmeler':
                                                                echo __('custom.views');
                                                                break;
                                                            case 'İndirmeler':
                                                                echo __('custom.downloads');
                                                                break;
                                                            case 'Görüntülemeler':
                                                                echo __('custom.impressions');
                                                                break;
                                                            default:
                                                                echo __('custom.transactions');
                                                                break;
                                                        }
                                                    @endphp
                                                    @if (Session::get('locale') == 'tr') gerçekleşti. @endif</div>
                                            @else
                                                <p>{{ __('custom.no_conversion_today') }}</p>
                                            @endif
                                        </div>
                                        <div>
                                            <div class="clockbox">
                                    ...
                                    <div class="cartoon"><img class="rounded-circle"
                                            ...
                                            alt="brand logo" width="140"
                                            style="max-height:140px; border-radius:50%; object-fit:contain;"></div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-6 col-xl-4 od-xl-4 box-col-4">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="card small-widget">
                                        <div class="card-body warning"> <span
                                                class="f-light">{{ __('custom.total_budget_label_dash') }}</span>
                                ...
                                <div class="col-4">
                                    <div class="card small-widget">
                                        <div class="card-body success"><span
                                                class="f-light">{{ __('custom.total_spent_label_dash') }}</span>
                                            <div class="d-flex align-items-end gap-1">
                                ...
                                <div class="col-4">
                                    <div class="card small-widget">
                                        <div class="card-body secondary"><span
                                                class="f-light">{{ __('custom.total_clicks_label') }}</span>
                                            <div class="d-flex align-items-end gap-1">
                                ...
                                <div class="col-4">
                                    <div class="card small-widget">
                                        <div class="card-body secondary"><span
                                                class="f-light">{{ __('custom.total_impressions_label') }}</span>
                                            <div class="d-flex align-items-end gap-1">
                                ...
                                <div class="col-4">
                                    <div class="card small-widget">
                                        <div class="card-body primary"> <span
                                                class="f-light">{{ __('custom.total_views_label') }}</span>
                                            <div class="d-flex align-items-end gap-1">
                                ...
                                <div class="col-4">
                                    <div class="card small-widget">
                                        <div class="card-body warning"><span
                                                class="f-light">{{ __('custom.total_sales_label') }}</span>
                                            <div class="d-flex align-items-end gap-1">
                            ...
                            <div class="card monthly-header">
                                <div class="card-header card-no-border">
                                    <div class="header-top">
                                        <h5>{{ __('custom.consumption_rate') }}</h5>
                                    </div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-sm-12 col-xl-4 box-col-4">
                            <div class="card">
                                <div class="card-header">
                                    <h5>{{ __('custom.media_based_budget') }}</h5>
                                </div>
                        ...
                        <div class="col-sm-12 col-xl-4 box-col-4">
                            <div class="card">
                                <div class="card-header">
                                    <h5>{{ __('custom.campaign_based_budget') }}</h5>
                                </div>
                        ...
                        <div class="col-xxl-12 col-xl-12 od-xl-12 box-col-12">
                            <div class="card heading-space">
                                <div class="card-header card-no-border">
                                    <div class="header-top">
                                        <h5 class="m-0">{{ __('custom.all_campaigns') }}</h5>
                                    </div>
                                </div>
                                <div class="card-body pt-0 px-0 campaign-table">
                                    <div class=" table-responsive currency-table stripe row-border order-column"
                                        style="width:100%">
                                        <table class="table" id="campaigns-table">
                                            <thead>
                                                <tr>
                                                    <th></th>
                                                    <th>{!! __('custom.campaign_name') !!}<br>ID</th>
                                                    <th>{!! __('custom.start') !!}<br>{!! __('custom.end') !!}</th>
                                                    <th>{!! __('custom.ad_model_count') !!}</th>
                                                    <th>{!! __('custom.campaign_type_count') !!}</th>
                                                    <th>{!! __('custom.planned_budget_count') !!}</th>
                                                    <th>{!! __('custom.spent_budget_count') !!}</th>
                                                    <th>{!! __('custom.unit_price_count') !!}</th>
                                                    <th>{!! __('custom.unit_percentage_count') !!}</th>
                                                    <th>{!! __('custom.click_count') !!}</th>
                                                    <th>{!! __('custom.sale_count') !!}</th>
                                                    <th>{!! __('custom.impression_count') !!}</th>
                                                    <th>{!! __('custom.download_count') !!}</th>
                                                    <th>{!! __('custom.view_count') !!}</th>
                                                ...
                                                @foreach ($campaignList['campaignList'] as $campaign)
                                                    <tr>
                                                        ...
                                                        <td>{{ $campaign->campaign_name }}<br>
                                                            <span class="text-gray">#{{ $campaign->campaign_id }}</span>
                                                        </td>
                                                        <td>{{ $campaign->start_date }}<br>
                                                            {{ $campaign->end_date }}</td>
                                                        <td>
                                                            <div
                                                                class="admodel-colorbox {{ strtolower($campaign->ad_model) }}">
                                                                {{ $campaign->ad_model }}
                                                            </div>
                                                        </td>
                                                        <td>{{ $campaign->campaign_type }}</td>
                                                        <td>{{ Number::format((int) $campaign->planned, locale: 'tr') }}₺
                                                        </td>
                                                        <td>{{ Number::format((int) $campaign->spent, locale: 'tr') }}₺
                                                        </td>
                                                        ...
                                                        <td>
                                                            <button class="btn badge-light-primary">
                                                                @php
                                                                    $statusKey = strtolower($campaign->status);
                                                                    $localizedStatus = __(
                                                                        'custom.status.' . $statusKey,
                                                                    );
                                                                @endphp
                                                                {{ $localizedStatus }}
                                                            </button>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td></td>
                                                    <td>{{ __('custom.totals') }}:</td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td>{{ Number::format($campaignList['totals']['planned'], locale: 'tr') }}₺
                                                    </td>
                                                    <td>{{ Number::format($campaignList['totals']['spent'], locale: 'tr') }}₺
                                                    </td>
                                                    <td>{{ Number::format((int) $campaignList['totals']['unit_price'], locale: 'tr') }}₺
                                                    </td>
                                                    <td>{{ (int) $campaignList['totals']['unit_percentage'] }}%</td>
                                                    <td>{{ Number::format($campaignList['totals']['clicks'], locale: 'tr') }}
                                                    </td>
                                                    <td>{{ Number::format($campaignList['totals']['sales'], locale: 'tr') }}
                                                    </td>
                                                    <td>{{ Number::format($campaignList['totals']['impressions'], locale: 'tr') }}
                                                    </td>
                                                    <td>{{ Number::format($campaignList['totals']['downloads'], locale: 'tr') }}
                                                    </td>
                                                    <td>{{ Number::format($campaignList['totals']['views'], locale: 'tr') }}
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            </tfoot>
...
--}}
    ...
    <script>
        $(document).ready(function() {
            ...
            window.translations = {
                planned: "{{ __('custom.planned') }}",
                spent: "{{ __('custom.spent') }}",
                media_based_budget_dist: "{{ __('custom.media_based_budget_dist') }}",
                campaign_type_dist: "{{ __('custom.campaign_type_dist') }}",
                campaign: "{{ __('custom.campaign') }}",
            };
            ...
            const translations = {
                pages: "{{ __('custom.pages') }}",
                infoEmpty: "{{ __('custom.info_empty') }}",
                search: "{{ __('custom.search') }}",
                infoFiltered: "{{ __('custom.info_filtered') }}",
                total_planned: "{{ __('custom.total_planned') }}",
                total_spent: "{{ __('custom.total_spent') }}",
                total_clicks: "{{ __('custom.total_clicks') }}",
            };
                ...
                plotOptions: {
                    radialBar: {
                        ...
                        dataLabels: {
                            ...
                            total: {
                                show: true,
                                label: "{{ __('custom.remaining') }}: {{ $totals['remaining'] }}₺",
                                fontSize: "14px",
            ...
            $("#campaigns-table").DataTable({
                ...
                "language": {
                    "info": "_PAGES_ {{ __('custom.pages') }} _PAGE_. {{ __('custom.showing') }}",
            ...
            function drawBasic() {
                ...
                if ($("#pie-chart1").length > 0) {
                    var data = google.visualization.arrayToDataTable([
                        ...
                        @foreach ($budgetDistribution as $platform => $info)
                            ["{!! $platform !!} : {{ number_format($info['spent'], 2, ',', '.') }}₺",
                                {{ $info['spent'] }}
                            ],
                        @endforeach
                    ]);
                    ...
                    var options = {
                        title: window.translations.media_based_budget_dist,
                        pieHole: 0.4,
                        width: "100%",
                        height: 300,
                        colors: [
                ...
                if ($("#pie-chart3").length > 0) {
                    ...
                    var options = {
                        title: window.translations.campaign_type_dist,
                        pieHole: 0.4,
                        width: "100%",
                        height: 300,
                        colors: [
                ...
                if ($("#column-chart1").length > 0) {
                    var data = google.visualization.arrayToDataTable([
                        [window.translations.campaign, window.translations.planned, window.translations
                            .spent
                        ],
                        @foreach ($campaignBudgetDistribution as $campaign)
                            ["{{ $campaign['campaign_name'] }}", {{ $campaign['planned'] }},
                                {{ $campaign['spent'] }}
                            ],
                        @endforeach
                    ]);
                    ...
                    chartTitle += '<span style="color: #A2A7FE; font-weight: bold;">' + window.translations
                        .planned + '</span> &nbsp;&nbsp;';
                    chartTitle += '<span style="color: #76E7CA; font-weight: bold;">' + window.translations.spent +
                        '</span>';
                    chartTitle += '</div>';
